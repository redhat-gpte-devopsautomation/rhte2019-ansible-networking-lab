...
* link:file:./1_Ansible_Networking_Lab.adoc[Part 1: Explore the environment with Ansible]
...
* link:file:./2_Ansible_Networking_Lab.adoc[Part 2: Backup, Configure, and Explore the Routers facts]
...
* link:file:./3_Ansible_Networking_Lab.adoc[Part 3: Reconfigure the Routers to connect 2 sites]
